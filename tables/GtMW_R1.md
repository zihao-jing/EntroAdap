> Table R1. Same-backbone comparison on GEO-AT using Llama-3.1-8B-Instruct. METEOR and BERTScore are reported (higher is better) by modality and as overall averages.
